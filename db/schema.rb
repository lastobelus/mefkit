...
ActiveRecord::Schema.define(version: 2019_09_07_223959) do
  ...
  create_table "admins", comment: "Admin users. Authentication by devise. Has a shadow user.", force: :cascade do |t|
  ...
  create_table "identities", comment: "Connects an Admin/User to an omniauth provider (git, google, facebook etc.)", force: :cascade do |t|
